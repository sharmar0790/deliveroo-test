...
import com.deliveroo.segments.Day;
import com.deliveroo.segments.Hour;
import com.deliveroo.segments.Minute;
import com.deliveroo.segments.Month;
import com.deliveroo.segments.Weekday;
import com.deliveroo.segments.Year;
...
public class CronParser {
    ...
    private CronParser(String expression)
    ...
    public String toString() {
        ...
        for (String section : displayOrder) {
            ...
            String displayString = CronParser.displayString.getOrDefault(section, section);
